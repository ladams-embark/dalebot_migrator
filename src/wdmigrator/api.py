...
def resolve(
    ...
    *,
    ...
    selected_time_calculation_tag_wids=(),
    selected_time_calculation_group_wids=(),
    ...
    return resolve_closure(
        ...
        selected_time_calculation_wids=selected_time_calculation_wids,
        selected_time_calculation_tag_wids=selected_time_calculation_tag_wids,
        selected_time_calculation_group_wids=selected_time_calculation_group_wids,
        time_calculation_index=time_calculation_index,
        time_calculation_tag_index=time_calculation_tag_index,
        time_calculation_group_index=time_calculation_group_index,
    )
